...
select madlib.lda_run('madlib.lda_mycorpus', 'madlib.lda_mydict', 'madlib.lda_mymodel', 'madlib.lda_corpus', 30,10,0.5,0.5);
select madlib.lda_label_test_documents('madlib.lda_testcorpus', 'madlib.lda_mymodel', 'madlib.lda_corpus', 'madlib.lda_mydict', 30,10,0.5,0.5);
