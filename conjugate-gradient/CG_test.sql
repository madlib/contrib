...
--INSERT INTO A SELECT g.a, ARRAY(SELECT random() FROM generate_series(1,10)) FROM generate_series(1,10) g(a);
--INSERT INTO A SELECT g.a, ARRAY(SELECT 1.0 FROM generate_series(1,10) k(a)) FROM generate_series(1,10) g(a);
--SELECT CG('A', 'val', 'row', ARRAY(SELECT random() FROM generate_series(1,10)), .001);

/*
INSERT INTO A VALUES(1, ARRAY[4,1]);
INSERT INTO A VALUES(2, ARRAY[1,3]);
SELECT CG('A', 'val', 'row', ARRAY[1,2], .0001);
*/

/*
INSERT INTO A VALUES(1, ARRAY[2,-1, 0]);
INSERT INTO A VALUES(2, ARRAY[-1, 2, -1]);
INSERT INTO A VALUES(3, ARRAY[0, -1, 2]);
SELECT CG('A', 'val', 'row', ARRAY[1,2,3], .0001);
*/
...
SELECT CG('A', 'val', 'row', ARRAY(SELECT random() FROM generate_series(1,10)), .000001);

/*
INSERT INTO A VALUES(1, ARRAY[1.0091058, 0.4665280, 0.33537718, 0.26375382, 0.21804643]);
INSERT INTO A VALUES(2, ARRAY[0.4665280, 0.4723232, 0.19697637, 0.15549576, 0.12888010]);
INSERT INTO A VALUES(3, ARRAY[0.3353772, 0.1969764, 0.34291086, 0.11302485, 0.09379653]);
INSERT INTO A VALUES(4, ARRAY[0.2637538, 0.1554958, 0.11302485, 0.28948911, 0.07432122]);
INSERT INTO A VALUES(5, ARRAY[0.2180464, 0.1288801, 0.09379653, 0.07432122, 0.26175589]);
SELECT CG('A', 'val', 'row', ARRAY(SELECT random() FROM generate_series(1,5)), .1);
*/